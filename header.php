            ...
            <div class="col-8  d-flex flex-row">
                    ...
                    ?>
                        <div class=" col-12 pt-3" onclick='cityLoad("<?php echo $district_data["id"]?>");'>
                            <div class="dist col-10 d-flex justify-content-center align-items-center">
                                <p class="pt-3 col-6" style="font-size: 16px;"><?php echo $district_data["name"]; ?></p>
                ...
                <div class="col-6 ">
                    <div class="col-12 area d-flex justify-content-center align-items-center ms-3" id="city_area" style="margin-top: 16px;">
                        <p style="font-size: 16px; font-weight: 400 ;color: #ff2a51; letter-spacing: 3px;">Select the District</p>
                    </div>
            ...
            <div class="col-8  d-flex flex-row">
                ...
                <div class="col-6 ms-3 ">
                    <div class="col-12 area d-flex justify-content-center align-items-center " style="margin-top: 16px;">
                        <p style="font-size: 16px; font-weight: 400 ;color: #ff2a51; letter-spacing: 3px;">Select the Category</p>
                    </div>
